...
class EnvelopesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create envelope" do
    assert_difference("Envelope.count") do
      post envelopes_url, params: { envelope: { amount: @envelope.amount, name: @envelope.name } }
    end
  ...
  test "should update envelope" do
    patch envelope_url(@envelope), params: { envelope: { amount: @envelope.amount, name: @envelope.name } }
